  ...
  mapContainers.forEach(function(container) {
    ...
    navButtons.forEach(function(btn) {
      btn.addEventListener('click', function(e) {
        ...
        if (buttonText === 'A') {
          openModal(`page/grp${groupNumber}/pageA.html`);
        } else if (buttonText === 'B') {
          openModal(`page/grp${groupNumber}/pageB.html`);
        } else if (buttonText === 'C') {
          openModal(`page/grp${groupNumber}/pageC.html`);
        } else if (buttonText === 'D') {
          openModal(`page/grp${groupNumber}/pageD.html`);
        }
      });
    });
